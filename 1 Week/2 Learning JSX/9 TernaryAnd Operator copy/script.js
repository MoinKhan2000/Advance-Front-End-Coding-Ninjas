...
const Dashboard = () => {
  ...
  return (
    <div className="container">
      ...
      <p><strong>Calculated Name</strong> {user.lastName || user.firstName || user.name}</p>
      ...
      {/* //! OR operator always gives the first truthy value and last falsy value*/}
      <p>
        console.log(false || "second true" || true || 'mkhan' || 'true' || 1 || false || "I am true") // 'second true'
      </p>
